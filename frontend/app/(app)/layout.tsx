        ...
        <header className="hidden md:flex justify-between items-center px-8 py-2 z-30 sticky top-0 bg-background/80 backdrop-blur-sm">
          ...
          <div className="flex items-center gap-6 relative">
            ...
            <button 
              ...
              className="relative p-2.5 rounded-full text-muted-foreground hover:bg-primary/10 hover:text-primary transition-all duration-300 group">
              <NotificationsIcon className="w-5 h-5 group-hover:rotate-[15deg] transition-transform duration-300" />
              {unreadCount > 0 && (
                <span className="absolute top-1 right-1 min-w-[18px] h-[18px] px-1 bg-destructive text-destructive-foreground text-[9px] font-black flex items-center justify-center rounded-full border-2 border-background shadow-sm ring-1 ring-destructive/10">
        ...
        <header className="w-full top-0 sticky bg-card border-b border-border shadow-sm z-30 md:hidden flex justify-between items-center px-6 h-16">
          ...
          <div className="flex gap-4 items-center relative">
            ...
            <button 
              ...
              <NotificationsIcon className="w-5 h-5 group-hover:rotate-[15deg] transition-transform duration-300" />
              {unreadCount > 0 && (
                <span className="absolute top-1 right-1 min-w-[18px] h-[18px] px-1 bg-destructive text-destructive-foreground text-[9px] font-black flex items-center justify-center rounded-full border-2 border-card shadow-sm ring-1 ring-destructive/10">
                  {unreadCount > 9 ? "9+" : unreadCount}
                </span>
              )}
            </button>
