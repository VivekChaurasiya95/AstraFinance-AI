...
export function CreateWorkspaceModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-3xl bg-card rounded-2xl shadow-xl border border-border overflow-hidden animate-in fade-in zoom-in-95 duration-200 flex flex-col max-h-[90vh]">
        ...
        <div className="px-8 py-5 border-t border-border-subtle bg-surface flex items-center justify-between shrink-0">
          <button
            onClick={onClose}
